...
$titre = "Formulaire pour la constitution d'équipes de joueurs";
?>
      ...
      <div id='exercice1' class="card col-8">
        <div class="card-body bg-info">
          ...
          if(isset($_GET['nbjoueur'])){
              ...
              for ($ind = 1; $ind <= $nbjoueur; $ind++){
                  form_input_text("Nom joueur $ind", "nom_$ind", 30, "nom joueur $ind");
                  form_input_text("Prénom joueur $ind", "prenom_$ind", 30, "prenom joueur $ind");
                  form_input_text("Email joueur $ind", "email_$ind", 30, "email joueur $ind");
              }
