    ...
    <div class="container">
      ...
      <div class="card">
        <div class="card-body bg-info">
          <h5 class="card-title">Exercice 1 : traiement du formulaire de soutenance</h5>
          <h3 class="card-title">SuperGlobale GET</h3>
          <div class='mx-lg-3'> 
      ...
      <p/><hr/><p/>
    <small>Page de Charlotte NOE rédigée le 05/04/2024</small>
    <p/><hr/><p/>
  </body>
</html>