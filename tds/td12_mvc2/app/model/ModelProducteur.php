...
// retourne une liste des id
 ...
 public static function insert($nom, $prenom, $region) {
  ...
  public static function getRegionSD() {
  try {
   $database = Model::getInstance();
  ...
  public static function getNbProducteur() {
  try {
   $database = Model::getInstance();
   $query = "SELECT region, COUNT(*) AS nb_producteurs FROM producteur GROUP BY region;";
   $statement = $database->prepare($query);
   $statement->execute();
 ...
 public static function delete($id) {
  try {
   $database = Model::getInstance();
   $query = "DELETE FROM recolte WHERE producteur_id = :id";
    $statement = $database->prepare($query);
