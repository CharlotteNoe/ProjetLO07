...
setcookie('nom_traitement', $_POST['nom_traitement'],$datelimite);
setcookie('finalite_traitement', $_POST['finalite_traitement'],$datelimite);
setcookie('donnees_perso', $_POST['donnees_perso'] ?? '',$datelimite);
setcookie('donnees_sensible', $_POST['donnees_sensible'] ?? '',$datelimite);
setcookie('donnees_hors_UE', $_POST['donnees_hors_UE'] ?? '',$datelimite);
?>
<html lang="fr">
  <head>
    <meta charset="utf-8">
