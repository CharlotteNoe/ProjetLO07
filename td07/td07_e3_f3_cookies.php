...
setcookie('nom_prenom_organisation', $_POST['nom_prenom_organisation'],$datelimite);
setcookie('nom_prenom_traitement', $_POST['nom_prenom_traitement'],$datelimite);
setcookie('nom_prenom_DPO', $_POST['nom_prenom_DPO'] ?? '',$datelimite);
?>
<html lang="fr">
  <head>
    <meta charset="utf-8">
    ...
    <div class="container">
      ...
      <div class="card">
        <div class="card-body bg-info">
          <h5 class="card-title">Formulaire 3 avec cookies</h5>

          <div class='mx-lg-3'> 
              <form action="td07_cookies.php" method="post">
                  <div class='mb-3'>
