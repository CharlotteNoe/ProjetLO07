...
<nav class="navbar navbar-expand-lg bg-success fixed-top">
  <div class="container-fluid">
     ...
     case ModelPersonne::ADMINISTRATEUR:
             echo('<a class="navbar-brand" href="router1.php?action=Accueil">NOE-| Administrateur | '.$_SESSION['nom'].' '.$_SESSION['prenom']. ' | </a>');
     break;
     case ModelPersonne::CLIENT:
             echo('<a class="navbar-brand" href="router1.php?action=Accueil">NOE-| Client | '.$_SESSION['nom'].' '.$_SESSION['prenom']. ' | </a>');
     break;
     default:
