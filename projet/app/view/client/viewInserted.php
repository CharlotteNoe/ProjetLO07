...
<div class="container">
    ...
    <?php
    if ($results == -1) {
        echo("<h4 class='mt-4 p-2 text-dark text-center bg-success rounded'>Problème d'insertion du compte</h4>");
        echo("label = " . $_GET['label']);
    } else {
        echo("<h4 class='mt-4 p-2 text-dark text-center bg-success rounded'>Le nouveau compte a été ajouté </h4>");
