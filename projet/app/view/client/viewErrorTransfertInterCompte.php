...
<div class="container">
    ...
    <form role="form" method='get' action='router1.php' class="mt-4 p-2 text-white bg-secondary rounded">
        <div class="form-group">
            ...
            <label for="compteMoins">Sélectionnez le compte d'où part l'argent : </label> <select class="form-control" id='compteMoins' name='compteMoins' style="width: 300px">
                <?php
            ...
            <label for="comptePlus">Sélectionnez le compte où arrive l'argent : </label> <select class="form-control" id='comptePlus' name='comptePlus' style="width: 300px">
                <?php
                foreach ($results as $compte) {
                    $id_compte=htmlspecialchars($compte['id']);
                    $label_compte=htmlspecialchars($compte['compte_label']);
